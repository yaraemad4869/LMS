...
namespace LearningManagementSystem.Controllers
{
    ...
    public class InstructorsController : ControllerBase
    {
        ...
        public InstructorsController(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor, ILoggingService loggingService, /*ILogger<InstructorsController> logger,*/ UserManager<User> userManager, IMemoryCache cache)
        {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            try
            {
                ...
                .SetPriority(CacheItemPriority.Normal);
                    ...
                    // Save data in cache
                    _cache.Set(_instructorIdCacheKey, instructors, cacheEntryOptions);
        ...
        public async Task<IActionResult> Post(Instructor instructor)
        {
            ...
            try
            {
                ...
                return CreatedAtAction(nameof(Post), new { id = instructor.Id }, instructor);
            }
            catch (Exception ex)
            {
